    ...
    mapper(0)
{
    ...
    ui->isocoinAtStartup->setToolTip(ui->isocoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->isocoinAtStartup->setText(ui->isocoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openIsocoinConfButton->setToolTip(ui->openIsocoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new IsocoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->isocoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openIsocoinConfButton_clicked()
{
