...
#ifndef ISOCOIN_QT_ISOCOINUNITS_H
#define ISOCOIN_QT_ISOCOINUNITS_H
...
/** Isocoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class IsocoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit IsocoinUnits(QObject *parent);

    /** Isocoin units.
      @note Source: https://en.isocoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef IsocoinUnits::Unit IsocoinUnit;

#endif // ISOCOIN_QT_ISOCOINUNITS_H
