...
#ifndef ISOCOIN_TEST_SCRIPTNUM10_H
#define ISOCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Isocoin Core 0.10.0, for cross-comparison.
 */
public:
