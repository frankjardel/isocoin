...
static void SetupIsocoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " isocoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  isocoin-tx [options] <hex-tx> [commands]  Update hex-encoded isocoin transaction\n" +
            "or:     isocoin-tx [options] -create [commands]   Create hex-encoded isocoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded isocoin transaction
