 ...
 */
#ifndef ISOCOIN_UTIL_H
#define ISOCOIN_UTIL_H
...
extern const char * const ISOCOIN_CONF_FILENAME;
extern const char * const ISOCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("isocoin-%s", name);
