...
#ifndef ISOCOIN_INTERFACES_NODE_H
#define ISOCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a isocoin node (isocoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // ISOCOIN_INTERFACES_NODE_H
