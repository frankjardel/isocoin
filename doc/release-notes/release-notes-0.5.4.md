Isocoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/isocoin/files/Isocoin/isocoin-0.5.4/
...
http://gitorious.org/isocoin/isocoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Isocoin-Qt notifications under Growl 1.3.
Increase required age of Isocoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxIsocoin properly when installing Isocoin-Qt over it. (Windows)
