Isocoin Core version 0.16.1 is now available from:

  <https://isocoincore.org/bin/isocoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting isocoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure isocoind processes are cleaned up when tests end (sdaftuar)
