Isocoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/isocoin/files/Isocoin/isocoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Isocoin
...
New/changed settings (command-line or isocoin.conf file)
--------------------------------------------------------
