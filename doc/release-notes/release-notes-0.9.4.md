Isocoin Core version 0.9.4 is now available from:

  https://isocoin.org/bin/0.9.4/
...
this update is incompatible with the Isocoin system and could lead to consensus
forks.

Isocoin Core released binaries from https://isocoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~isocoin/+archive/ubuntu/isocoin
- A third-party or self-compiled Isocoin Core

upgrade to Isocoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
