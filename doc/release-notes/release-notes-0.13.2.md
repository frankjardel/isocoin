Isocoin Core version 0.13.2 is now available from:

  <https://isocoin.org/bin/isocoin-core-0.13.2/>
...
- #8908 `4a974b2` Update isocoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow isocoin-tx to create v2 transactions (btcdrak)
