Isocoin Core version 0.10.4 is now available from:

  <https://isocoin.org/bin/isocoin-core-0.10.4/>
...
- #6953 `43c2789` Split isocoin-tx into its own package
- #6953 `dfe0d4d` Include isocoin-tx binary on Debian/Ubuntu
