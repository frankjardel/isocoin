...
* isocoin.conf: contains configuration settings for isocoind or isocoin-qt
* isocoind.pid: stores the process id of isocoind while running
...
* debug.log: contains debug information and general logging generated by isocoind or isocoin-qt
