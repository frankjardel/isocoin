...
"""Verify that starting isocoin with -h works as expected."""

from test_framework.test_framework import IsocoinTestFramework
from test_framework.util import assert_equal

class HelpTest(IsocoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start isocoin with -h for help text")
        ...
        self.log.info("Start isocoin with -version for version information")
        ...
        self.log.info("Start isocoind with -fakearg to make sure it does not start")
