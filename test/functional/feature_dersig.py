...
class BIP66Test(IsocoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # isocoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and isocoind produces more specific reject
            # reasons.
