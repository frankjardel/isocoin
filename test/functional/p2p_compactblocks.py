...
# TestP2PConn: A peer we use to send messages to isocoind, and store responses.
...
class CompactBlocksTest(IsocoinTestFramework):
    ...
    # This test actually causes isocoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that isocoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for isocoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # isocoind will not send blocktxn responses for blocks whose height is
